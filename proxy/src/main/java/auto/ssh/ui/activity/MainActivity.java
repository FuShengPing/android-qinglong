...
public class MainActivity extends BaseActivity {
    ...
    private void onProxyServiceOpen() {
        ...
        this.uiLocal.setCardBackgroundColor(getResources().getColor(R.color.proxy_theme_color, null));
    ...
    private void onForwardServiceOpen() {
        ...
        this.uiForward.setCardBackgroundColor(getResources().getColor(R.color.proxy_theme_color, null));
